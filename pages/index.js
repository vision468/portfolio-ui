...
import { RefreshIcon, HeartIcon } from "@heroicons/react/outline";
  ...
  return (
    <main className="w-full  p-10">
      <div className="flex flex-col md:flex-row-reverse items-center gap-5 relative">
        ...
        <div>
          <Title className="text-5xl md:text-4xl font-bold">Main Title</Title>
